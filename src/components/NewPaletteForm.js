  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        ...
        >
          ...
          <ValidatorForm onSubmit={this.addNewColor} ref='form'>
            ...
            <Button
              ...
              type='submit'
              color='primary'
              style={{ backgroundColor: !paletteIsFull ? this.state.currentColor : 'rgba(0, 0, 0, 0.26)' }}
        ...
        >
          <div className={classes.drawerHeader} />
          <DraggableColorList axis="xy" onSortEnd={this.onSortEnd} removeColor={this.removeColor} colors={colors} />
        </main>
      </div>
    );
  }
